...
wn = turtle.Screen()
wn.title("Flappy Bird by Alec and Kai")
wn.bgcolor("blue")
...
value = randint(0, 11)
print(value)
#random Background Generator or RBG
background=['background.gif','background2.gif','background3.gif','background4.gif','background5gif.gif','background6.gif','background7.gif','background8.gif','background9.gif','background10.gif','background11.gif','fish.gif']
wn.bgpic(background[value])
